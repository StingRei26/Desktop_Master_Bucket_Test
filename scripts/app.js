...
// The Below Code Controls the left and right nav button on diffrent view ports

function numSlides() {
      if (numberOfItem <= 3) {
          document.getElementById("desktopLeftArrowContainer").style.display = "none"; 
          document.getElementById("desktopRightArrowContainer").style.display = "none"; 
      }

}

numSlides();
console.log("there are " + numberOfItem + " in the slideshow");


function myMatch(y) {
  if (y.matches && numberOfItem <= 3) {
    document.getElementById("desktopLeftArrowContainer").style.display = "block"; 
    document.getElementById("desktopRightArrowContainer").style.display = "block";  
  } 
}

var y = window.matchMedia("(max-width: 1280px)")
myMatch(y)
y.addListener(myMatch)


function myMatch2(r) {
  if (r.matches && numberOfItem <= 3) {
    document.getElementById("desktopLeftArrowContainer").style.display = "none"; 
    document.getElementById("desktopRightArrowContainer").style.display = "none";  
  } 
}

var r = window.matchMedia("(min-width: 1280px)")
myMatch2(r)
r.addListener(myMatch2)
